                      ...
                      while($out = mysqli_fetch_array($run)){
                         $statuss= $out['status']
                             ...
                             ?>
                                  ...
                                  <input type="text" onclick="this.select()" name="address" placeholder="Enter Address" class="d-none form-control" style="font-size:12px;" id="addressgmail" value="<?php echo $out['address'] ?>"> <a class="d-none" id="cancelbtnaddgmail" href="#"  style="font-size:12px;cursor:link;">Cancel</a>
                                 <h5 id="addresshidgmail">Address:  <?php echo $out['address'] ?> <a href="#" style="font-size:16px"class="editaddressgmail" >Edit</a></h5>
                                
                                     <input onclick="this.select()" type="text" value="<?php echo $out['contact_no'] ?>"  maxlength='11' placeholder="0955-222-3333" name="contactno" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="d-none form-control" style="font-size:12px;width:160px" id="contactnogmail"> <a class="d-none" id="cancelbtngmail" href="#"  style="font-size:12px;cursor:link;">Cancel</a>
                                       ...
                                       <?php 
                                            ...
                                            ?>
                                       <a href="#"   style="font-size:16px" class="editcontactgmail" style="font-size:12px;cursor:link">Edit</a></h5>
                                  ...
                                  <h5>Login Credentials: <span style='text-transform:capitalize'> <?php echo $out['logintype']?> </span></h5>
                                    ...
                                    if(isset($_SESSION['user_id'])) {
                                        ?>
                                        <h5>Name : <?php echo $out['uname'].' '. $out['surname'] ?>  </h5>
                                  <input type="text" onclick="this.select()" name="address" placeholder="Enter Address" class="d-none form-control" style="font-size:12px;" id="address" value="<?php echo $out['address'] ?>"> <a class="d-none" id="cancelbtnadd" href="#"  style="font-size:12px;cursor:link;">Cancel</a>
                                 <h5 id="addresshid">Address:  <?php echo $out['address'] ?> <a href="#" style="font-size:16px"class="editaddress" >Edit</a></h5>
                                
                                     <input onclick="this.select()" type="text" value="<?php echo $out['contact_no'] ?>"  maxlength='11' placeholder="0955-222-3333" name="contactno" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="d-none form-control" style="font-size:12px;width:160px" id="contactno"> <a class="d-none" id="cancelbtn" href="#"  style="font-size:12px;cursor:link;">Cancel</a>
                                       ...
                                       <a href="#"   style="font-size:16px" class="editcontact" style="font-size:12px;cursor:link">Edit</a></h5>
                                  ...
                                  <input type="password" onclick="this.select()"  placeholder="Enter New Password" class="d-none form-control"   style="font-size:12px;" id="password" ><a class="d-none" id="cancelpass" href="#"  style="font-size:12px;cursor:link;">Cancel</a>
                                    <input type="hidden" id="hiddenpass" value=<?php echo $out['password']?>>    
                                        <h5 id="passwordhid">Password :  ●●●●●   <a href="#" style="font-size:16px"class="editpassword" >Edit</a></h5> <p></p>
