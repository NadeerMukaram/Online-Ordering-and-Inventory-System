...
<link href="../css/login-stylea.css?v=0600" rel="stylesheet">
<link href="../css/login-styleb.css?v=0680" rel="stylesheet">
...
<body class="night sunset day" style="font-family: 'Titillium Web', sans-serif;">
...
<div class="container logincontainer">
		<div class="col-md-12 text-center hantechlogo">
			<a href="../home"><img src="../img/hantech_official_logo_ok_alt.png" alt="logo" id="idel"></a>
		</div>
		<style>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<h3><a href="#" class="active" id="login-form-link">SIGN IN</a></h3>
							</div>
							<div class="col-xs-6">
								<h3><a href="#" id="register-form-link">SIGN UP</a></h3>
							</div>
						</div>
						<hr>
					</div>
					    ...
					    <?php
					      if(isset($_GET['failed-Authentication'])) {
					          ?>
					            ...
					            <script>
					                setInterval(function(){  document.getElementById('hidethis').setAttribute('style','display:none'); }, 10000);
					            </script>
					          <?php
							...
							<div class="col-lg-12">
								<form id="login-form" action="login.php" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Email" value="" autofocus>
									</div>
									<div class="form-group">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="recovery.php" tabindex="5" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
								...
								<form id="register-form" action="login.php" method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<input type="text" name="contact"  tabindex="4" class="form-control" placeholder="Contact#" maxlength="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" required>
									</div>
									<div class="form-group">
