...
$_SESSION['accounts'] = '1';
 include 'includes/header.php';?>
  ...
  <?php include 'includes/sidebar.php'; include 'class.php'?>
 ...
 <style type="text/css">
  ...
  <main class="page-content">
    <div class="container-fluid">
      <h2 style="font-family: 'Jost', sans-serif;letter-spacing: 5px;">ACCOUNTS</h2>
      <hr>
         ...
         <div class="card">
          ...
          <button class="btn btn-info clicksessionadd"  data-toggle="modal" data-target="#addnew" style="width: 10%;font-size: 12px">Add New <i class="fas fa-plus"></i></button>
            ...
            <?php include 'modals/addnewproduct.php';
             ...
             if (isset($_GET['Edit'])) {
               $user_id = $_GET['prodid'];
            include 'modals/editmodalacc.php';
            }else if (isset($_GET['del'])) {
               $user_id = $_GET['prodid'];
               include 'modals/deleteacc.php';
            }
            ?>
